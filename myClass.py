...
class Predict:
    def predict(self,X_img, knn_clf=None, model_path=None, distance_threshold=0.6):
    
        #if not os.path.isfile(X_img) or os.path.splitext(X_img)[1][1:] not in ALLOWED_EXTENSIONS:
            #raise Exception("Invalid image path: {}".format(X_img))
...
class SaveImage:
    ...
    def show_prediction_labels_on_image(self,img, predictions):
        ...
        for name, (top, right, bottom, left) in predictions:
            ...
            text_width, text_height = TextSize.textsize(name,font=font)
            ...
            output_path = os.path.join(output_folder, f"{name}_rect.jpg")
